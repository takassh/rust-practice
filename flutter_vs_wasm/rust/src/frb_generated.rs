...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = 678028270;
...
fn wire__crate__api__image_processing__pic2edge_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync::<flutter_rust_bridge::for_generated::SseCodec, _>(
        ...
        move || {
            ...
            transform_result_sse((move || {
                Result::<_, ()>::Ok(crate::api::image_processing::pic2edge(api_buffer))
            })())
        },
    )
}
...
fn pde_ffi_dispatcher_sync_impl(
    ...
    // Codec=Pde (Serialization + dispatch), see doc to use other codecs
    match func_id {
        1 => wire__crate__api__image_processing__pic2edge_impl(ptr, rust_vec_len, data_len),
